...
A 5+2 model is used, with each color corresponding to a number position.

Non-technical users don't need to worry about number positions; these are covered in detail in the specific algorithm. The final table is provided to facilitate future derivation and calculation of new strategies.
